...
$spek = query("SELECT * FROM spek");

// query sesuai dengan keyword pencarian ketika tombol cari di klik
if (isset($_GET['cari'])) {
    $keyword = $_GET["keyword"];
    $query = "SELECT * FROM spek WHERE nama LIKE '%$keyword%' OR deskripsi LIKE '%keyword%' ";
    $spek = query($query);
}
?>
...
<head>
    ...
    <!-- CSS -->
    <link rel="stylesheet" href="asus.css?v=<?php echo time(); ?>">
...
<body>
    ...
    <div class="image">
        <img src="../image/logoasus.png" alt="" width="500">
    </div>
