...
$spek = query("SELECT * FROM hp");

// query sesuai dengan keyword pencarian ketika tombol cari di klik
if (isset($_GET['cari'])) {
    $keyword = $_GET["keyword"];
    $query = "SELECT * FROM hp WHERE nama LIKE '%$keyword%' OR deskripsi LIKE '%keyword%' ";
    $spek = query($query);
}
?>
...
<head>
    ...
    <!-- CSS -->
    <link rel="stylesheet" href="hp.css?v=<?php echo time(); ?>">
...
<body>
    ...
    <div class="image">
        <img src="../image/logohp.png" alt="" width="250">
    </div>
