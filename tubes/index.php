...
<body>
            ...
            <div class="collapse navbar-collapse float-end menu" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item log-sig">
                        <a class="link-log" href="log/login.php" role="button">Login</a>
                        <a class="btn btn-primary btn-md button-order" href="log/register.php" role="button">Sign Up</a>
                    </li>
                </ul>
    ...
    <header>
        <div class="text-mid">
            ...
            <h6>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eveniet, quas.</h6>
            <a class="btn btn-primary btn-md button-order" href="#tag-card" role="button">Find More Details</a>
        </div>
    </header>
    ...
    <section class="cs3" id="about">
        ...
        <div class="about">
            <h5>TechSpec is a website to inform those who are looking for some <br> information about good and complete laptop specifications.</h5>
            <h5>and can also help to find what laptop and <br> what specifications match what you want</h5>
        </div>
    </section>
    ...
    <section class="tag-card" id="tag-card">
        <div class="col">
            <div class="card">
                ...
                <a class="btn btn-primary btn-md button-order" href="log/login.php" role="button">Select</a>
            </div>
        </div>
        <div class="col">
            <div class="card">
