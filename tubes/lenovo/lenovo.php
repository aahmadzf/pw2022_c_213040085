...
$spek = query("SELECT * FROM lenovo");

// query sesuai dengan keyword pencarian ketika tombol cari di klik
if (isset($_GET['cari'])) {
    $keyword = $_GET["keyword"];
    $query = "SELECT * FROM lenovo WHERE nama LIKE '%$keyword%' OR deskripsi LIKE '%keyword%' ";
    $spek = query($query);
}
?>
...
<head>
    ...
    <!-- CSS -->
    <link rel="stylesheet" href="lenovo.css?v=<?php echo time(); ?>">
...
<body>
    ...
    <div class="image">
        <img src="../image/Logolenovo.jpg" alt="" width="500">
    </div>
